...
# OSTICKET
ARG OSTICKET_URL="{}"
ENV OSTICKET_URL ${OSTICKET_URL}

# NEXTCLOUD
ARG NEXTCLOUD_URL="https://cloud.example.com/"
ENV NEXTCLOUD_URL ${NEXTCLOUD_URL}
ARG NEXTCLOUD_REDIS="redis://localhost:6379/4"
ENV NEXTCLOUD_REDIS ${NEXTCLOUD_REDIS}
ARG NEXTCLOUD_TTL="60"
ENV NEXTCLOUD_TTL ${NEXTCLOUD_TTL}
