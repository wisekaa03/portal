...
export const docFlowTask = (task: DocFlowTaskSOAP): DocFlowTask => ({
  ...
  beginDate: task.object.beginDate ?? undefined,
  dueDate: task.object.dueDate ?? undefined,
  endDate: task.object.endDate ?? undefined,
  ...
  acceptDate: task.object.acceptDate ?? undefined,
