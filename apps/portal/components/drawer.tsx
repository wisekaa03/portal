...
const urls: UrlProps[] = [
  ...
  { icon: CalendarIcon, text: 'common:calendar', link: '/calendar', admin: true },
  { icon: FaqIcon, text: 'common:faq', link: '/faq', admin: true },
  { icon: MeetingIcon, text: 'common:meeting', link: '/meetings', admin: true },
  { icon: NewsIcon, text: 'common:news', link: '/news', admin: true },
  {
    icon: MediaIcon,
    text: 'common:media',
    link: '/media',
