...
const Wire: React.FC = ({ children, ...props }) => Children.only(typeof children === 'function' ? children(props) : null);

const PhonebookProfileControl: React.FC<PhonebookProfileControlProps> = ({
  controlEl,
  profileId: id,
  handleControl,
  handleCloseControl,
